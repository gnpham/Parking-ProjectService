		...
		<ul class="nav navbar-top-links navbar-right">
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu dropdown-user">
					...
					<li class="divider"></li>
					<li><a href="doLogout" action = "#"><i class="fa fa-sign-out fa-fw"></i>
							Đăng xuất</a></li>
				</ul> <!-- /.dropdown-user --></li>
			<!-- /.dropdown -->
		</ul>
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="<%=request.getContextPath()%>/admin/QLChuNhaXe.jsp">
						<i class="fa fa-table fa-fw"></i>Quản lý chủ nhà xe</a>
					</li>
					
					<li><a href="#">
						<i class="fa fa-table fa-fw"></i>Quản lý nhà xe<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
						    <li><a href="<%=request.getContextPath()%>/admin/QLNhaXe.jsp">Nhà Xe</a></li>
							<li><a href="<%=request.getContextPath()%>/admin/QLThoiGianDongMoCua.jsp">Thời gian Đóng/ Mở cửa</a></li>
						</ul> <!-- /.nav-second-level -->
					</li>
					
					<li><a href="<%=request.getContextPath()%>/admin/QLKhuVuc.jsp">
						<i class="fa fa-table fa-fw"></i>Khu Vực</a>
					</li>
